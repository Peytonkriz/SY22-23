Public Class Form1
    ...
    Private Sub Button105_Click(sender As Object, e As EventArgs) Handles Button105.Click, Button104.Click, Button103.Click, Button102.Click
        drawcolor = sender.backcolor

    End Sub

    Private Sub Button105_MouseDown(sender As Object, e As MouseEventArgs) Handles Button105.MouseDown, Button104.MouseDown, Button103.MouseDown, Button102.MouseDown
